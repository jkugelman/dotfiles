# Generated by Powerlevel10k configuration wizard on 2019-11-16 at 02:27 UTC.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 40905.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, time,
# angled separators, sharp heads, flat tails, 2 lines, dotted, no frame, lightest,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=029
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=029
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=029
  ...
  POWERLEVEL9K_USER_DEFAULT_BACKGROUND=033
  ...
  POWERLEVEL9K_HOST_REMOTE_FOREGROUND=253
  POWERLEVEL9K_HOST_REMOTE_BACKGROUND=055
